...
\centerline{}
\centerline{\Letter: \href{mailto:chcheng@illinois.edu}{chcheng@illinois.edu}}
...
\begin{itemize}
	...
	\begin{itemize}
		\item [--] \textbf{Assistant Professor}, Department of Statistics. \hfill 8/2026 -- Current
		\item [--] \textbf{Affiliated Positions}
		\begin{itemize}
			\item [--] \textbf{Core Member}, NSF-Simons AI Institute for the Sky (SkAI Institute). \hfill 8/2026 -- Current
		\end{itemize}
	\end{itemize}
	\item[] \textbf{University of Chicago}, IL, USA
	\begin{itemize}
		\item [--] \textbf{Postdoctoral Scholar}, Department of Statistics. \hfill 8/2025 -- 8/2026 \\
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item [--] GPA: $3.90/4.00$, Rank: $1/18$. (with distinction)
	\end{itemize}
\end{itemize}
...
\begin{enumerate}
	\item[\namedlabel{pub:RollingCP}{P16}] \textbf{C. Cheng}, R. Liang, R. F. Barber. ``Rolling Conformal Prediction in Sequential Model Training'', 2026. \href{https://arxiv.org/abs/2609.26951}{\textcolor{blue}{arXiv}}.
	\item[\namedlabel{pub:DROBidding}{P15}] Y. Zhang, \textbf{C. Cheng}, S. Feng, Z. Zhou. ``Distributionally Robust Bidding in First-Price Auctions'', 2026. Accepted to the 65th IEEE Conference on Decision and Control (CDC), 2026. \href{https://moriartycc.github.io/files/papers/distributionally-robust-bidding-first-price-auctions.pdf}{\textcolor{blue}{Full}}.
	\item[\namedlabel{pub:IsMemorizationHelpful}{P14}] \textbf{C. Cheng}, R. F. Barber. ``Is Memorization Helpful or Harmful? Prior Information Sets the Threshold'', 2026. Proceedings of the Thirty-Ninth Conference on Learning Theory (COLT), PMLR 336:1399--1433, 2026. \href{https://proceedings.mlr.press/v336/cheng26a.html}{\textcolor{blue}{PMLR}}. \href{https://arxiv.org/abs/2602.09405}{\textcolor{blue}{arXiv}}. Presented in [\ref{talk:IOC-26-2}, \ref{talk:COLT-26-3}, \ref{talk:IMS-26-4}].
	...
	\item[\namedlabel{pub:SomeRobustness}{P12}] \textbf{C. Cheng}, J. Duchi. ``Some Robustness Properties of Label Cleaning'', 2025. Transactions on Machine Learning Research (TMLR), 2026. \href{https://arxiv.org/abs/2509.11379}{\textcolor{blue}{arXiv}}.
	...
	\item[\namedlabel{pub:GeometryComputation}{P10}] \textbf{C. Cheng}, J. Duchi, D. Levy. ``Geometry, Computation, and Optimality in Stochastic Optimization'', 2024. Accepted to Mathematics of Operations Research, 2026. \href{https://arxiv.org/abs/1909.10455}{\textcolor{blue}{arXiv}}.
	\item[\namedlabel{pub:TwoFundamental}{P9}] F. Areces, \textbf{C. Cheng}, J. Duchi, R. Kuditipudi. ``Two Fundamental Limits for Uncertainty Quantification in Predictive Inference'', 2024. Proceedings of the Thirty-Seventh Conference on Learning Theory (COLT), PMLR 247:186--218, 2024. \href{https://proceedings.mlr.press/v247/areces24a.html}{\textcolor{blue}{PMLR}}.
	...
	\item[\namedlabel{pub:HighdimensionalFlow}{P4}] M. Celentano, \textbf{C. Cheng}, A. Montanari. ``The High-dimensional Asymptotics of First Order Methods with Random Data'', 2021. Accepted to Annals of Applied Probability, 2026. \href{https://arxiv.org/abs/2112.07572}{\textcolor{blue}{arXiv}}. Presented in [\ref{talk:Berkeley-24-1}].
...
\subsection*{\textbf{Fellowship \& Scholarship}}
	\begin{itemize}
		\item[--] William R. Hewlett Stanford Graduate Fellowship. \hfill 09/2019
		\item[--] Yizheng Special Scholarship and Merit Student. \hfill 09/2018
		\item[--] Leo-KoGuan Scholarship and Merit Student. \hfill 09/2017
		\item[--] National Scholarship and Merit Student Pacesetter (Highest Honor) . \hfill 09/2016
	\end{itemize}
\subsection*{\textbf{Awards}}
	\begin{itemize}
		\item[--] George E. Nicholson Student Paper Competition. Finalist. \hfill 10/2021
		\item[--] Excellent Graduate of Beijing. \hfill 06/2019
		\item[--] Excellent Graduate of Elite Training Program of Applied Mathematics. \hfill 06/2019
		\item[--] S.T. Yau College Student Mathematics Contests -- Group (Probability). Silver Medalist. \hfill 08/2017
...
\begin{enumerate}
	\item[\namedlabel{talk:IMS-26-4}{T21}] [\ref{pub:IsMemorizationHelpful}] IMS New Researcher Conference, UMass Amherst. \hfill 07/2026
	\item[\namedlabel{talk:COLT-26-3}{T20}] [\ref{pub:IsMemorizationHelpful}] Conference on Learning Theory (COLT), San Diego. \hfill 07/2026
	\item[\namedlabel{talk:IOC-26-2}{T19}] [\ref{pub:IsMemorizationHelpful}] INFORMS Optimization Society Conference, Atlanta. \hfill 03/2026
	\item[\namedlabel{talk:UF-26-1}{T18}] Workshop in Frontiers in Learning Under Data Heterogeneity, University of Florida. \hfill 01/2026
	\item[\namedlabel{talk:NITMB-25-8}{T17}] NSF-Simons NITMB MathBio Convergence Conference, Chicago. \hfill 08/2025 
	\item[\namedlabel{talk:UIUC-25-1}{T16}] [\ref{pub:HowMany}, \ref{pub:DimensionFree}], Statistics Seminar, University of Illinois Urbana-Champaign. \hfill 01/2025
	\item[\namedlabel{talk:Rutgers-25-1}{T15}] [\ref{pub:HowMany}, \ref{pub:DimensionFree}], Statistics Seminar, Rutgers University New Brunswick. \hfill 01/2025
	\item[\namedlabel{talk:NYU-25-1}{T14}] [\ref{pub:HowMany}, \ref{pub:DimensionFree}], Statistics Seminar, New York University Stern. \hfill 01/2025
	\item[\namedlabel{talk:Cambridge-25-1}{T13}] [\ref{pub:HowMany}, \ref{pub:DimensionFree}], Statistics Seminar, University of Cambridge DPMMS. \hfill 01/2025
...
\subsection*{\textbf{As Instructor (UIUC)}}

\begin{itemize}
	\item[--] STAT 410. Statistics and Probability II. \hfill Fall 2026
\end{itemize}

\subsection*{\textbf{As Teaching Assistant (Stanford)}}
...
\subsubsection*{Journal} The Annals of Statistics (AoS), Journal of the American Statistical Association (JASA), Journal of the Royal Statistical Society, Series B: Statistical Methodology (JRSSB), Journal of Machine Learning Research (JMLR), IEEE Transactions on Pattern Analysis and Machine Intelligence (IEEE TPAMI), IEEE Transactions on Information Theory (IEEE TIT), Bernoulli, Foundations of Computational Mathematics (FoCM), Transactions on Machine Learning Research (TMLR), SIAM Journal on Mathematics of Data Science (SIMODS), Information and Inference: A Journal of the IMA (Inf. Inference), Mathematical Statistics and Learning (MSL), Electronic Communications in Probability (ECP)

\subsubsection*{Conference} Conference on Neural Information Processing Systems (NeurIPS), International Conference on Machine Learning (ICML), International Conference on Learning Representations (ICLR), ACM Symposium on Theory of Computing (STOC), Conference on Learning Theory (COLT), IEEE International Symposium on Information Theory (ISIT), International Conference on Algorithmic Learning Theory (ALT)

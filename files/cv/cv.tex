...
\begin{enumerate}
	\item[\namedlabel{pub:IsMemorizationHelpful}{P14}] \textbf{C. Cheng}, R. F. Barber. ``Is Memorization Helpful or Harmful? Prior Information Sets the Threshold'', 2026. Presented in [\ref{talk:IOC-26-2}, \ref{talk:COLT-26-3}] Conference on Learning Theory (COLT), 2026.
